...
type StorageKey = 'projects' | 'project-attachments' | 'project-milestones' | 'project-photos' | 'project-notes' | 'donorReceipts' | 'donorPledges' | 'exchangeRate' | 'disbursed-amounts-migrated' | 'fund-reallocations' | 'undesignated-funds' | 'fund-reallocations-to-pledge' | 'impactDemographics';
